...
flowchart LR
    ...
    Client <-->|"POST /events/batch<br/>POST /reports/generate<br/>GET /reports/{task_id}<br/>GET /analytics/metrics"| API[FastAPI Gateway]
    ...
    API <-->|Read on cache miss:<br/>report status, metrics| DB
